...
public class OpenShiftCreationDay4Shift1 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationDay4Shift1(WebDriver 	rdriver){
    	ldriver=rdriver;
