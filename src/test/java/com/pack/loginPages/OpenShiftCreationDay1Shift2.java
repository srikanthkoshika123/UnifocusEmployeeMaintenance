...
public class OpenShiftCreationDay1Shift2 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationDay1Shift2(WebDriver 	rdriver){
    	ldriver=rdriver;
