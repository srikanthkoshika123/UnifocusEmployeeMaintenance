...
public class OpenShiftCreationSunday2 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationSunday2(WebDriver 	rdriver){
    	ldriver=rdriver;
	...
	WebElement dr=driver.findElement(By.xpath("//*[@id=\"root\"]/div/section/section/main/div/div/section/div/div[2]/div/div/div/div/div/div[2]/div[1]/div[2]/div[2]/div/div[2]/div[7]/div/button"));
	Thread.sleep(8000);
	dr.click();
	Thread.sleep(8000);
