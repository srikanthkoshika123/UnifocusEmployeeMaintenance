...
public class OpenShiftCreationSunday1 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationSunday1(WebDriver 	rdriver){
    	ldriver=rdriver;
