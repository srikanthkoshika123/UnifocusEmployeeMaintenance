...
import com.pack.loginPages.AssignShiftDay4Shift2;
import com.pack.loginPages.EditShiftDay4Shift2;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay4Shift2 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay4Shift2 editShift=new EditShiftDay4Shift2(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay4Shift2 assign=new AssignShiftDay4Shift2(driver);
	assign.selectFrame();
