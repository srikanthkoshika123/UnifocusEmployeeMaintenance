...
import com.pack.loginPages.AssignShiftDay5Shift1;
import com.pack.loginPages.EditShiftDay5Shift1;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay5Shift1 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay5Shift1 editShift=new EditShiftDay5Shift1(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay5Shift1 assign=new AssignShiftDay5Shift1(driver);
	assign.selectFrame();
