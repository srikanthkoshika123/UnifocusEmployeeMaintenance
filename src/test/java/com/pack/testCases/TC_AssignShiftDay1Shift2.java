...
import com.pack.loginPages.AssignShiftDay1Shift2;
import com.pack.loginPages.EditShiftDay1Shift2;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay1Shift2 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay1Shift2 editShift=new EditShiftDay1Shift2(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay1Shift2 assign=new AssignShiftDay1Shift2(driver);
	assign.selectFrame();
