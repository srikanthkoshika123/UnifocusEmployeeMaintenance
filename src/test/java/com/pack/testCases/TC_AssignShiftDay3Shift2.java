...
import com.pack.loginPages.AssignShiftDay3Shift2;
import com.pack.loginPages.EditShiftDay3Shift2;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay3Shift2 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay3Shift2 editShift=new EditShiftDay3Shift2(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay3Shift2 assign=new AssignShiftDay3Shift2(driver);
	assign.selectFrame();
