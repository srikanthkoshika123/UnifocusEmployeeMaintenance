...
import com.pack.loginPages.AssignShiftDay2Shift1;
import com.pack.loginPages.EditShiftDay2Shift1;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay2Shift1 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay2Shift1 editShift=new EditShiftDay2Shift1(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay2Shift1 assign=new AssignShiftDay2Shift1(driver);
	assign.selectFrame();
