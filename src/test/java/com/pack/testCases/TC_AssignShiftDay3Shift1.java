...
public class TC_AssignShiftDay3Shift1 extends TC_BaseClass{
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay3Shift1 assign=new AssignShiftDay3Shift1(driver);
	assign.selectFrame();
