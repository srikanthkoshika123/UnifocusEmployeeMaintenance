...
import com.pack.loginPages.AssignShiftDay2Shift2;
import com.pack.loginPages.EditShiftDay2Shift2;
import com.pack.loginPages.LoginPage;
import com.pack.loginPages.MainPages;

public class TC_AssignShiftDay2Shift2 extends TC_BaseClass{
	@Test
	public void assignShift() throws IOException, InterruptedException {
       ...
       Thread.sleep(4000);
   	EditShiftDay2Shift2 editShift=new EditShiftDay2Shift2(driver);
    ...
    editShift.clickUpdateShift();
     ...
     Thread.sleep(4000);	
	AssignShiftDay2Shift2 assign=new AssignShiftDay2Shift2(driver);
	assign.selectFrame();
