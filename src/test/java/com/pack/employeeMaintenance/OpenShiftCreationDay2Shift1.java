...
public class OpenShiftCreationDay2Shift1 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationDay2Shift1(WebDriver 	rdriver){
    	ldriver=rdriver;
