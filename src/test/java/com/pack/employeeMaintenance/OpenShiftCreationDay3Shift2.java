...
public class OpenShiftCreationDay3Shift2 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationDay3Shift2(WebDriver 	rdriver){
    	ldriver=rdriver;
