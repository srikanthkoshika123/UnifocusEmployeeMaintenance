...
public class OpenShiftCreationDay3Shift1 extends TC_BaseClass{

	WebDriver ldriver;
	public OpenShiftCreationDay3Shift1(WebDriver 	rdriver){
    	ldriver=rdriver;
